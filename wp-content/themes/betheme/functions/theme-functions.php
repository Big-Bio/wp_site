...
if ( function_exists( 'add_theme_support' ) ) {
	...
	// @deprecated since 8.7, replaced with 'portfolio-mf'
// 	add_image_size( 'portfolio', 		640,  500,  true  ); 	// portfolio
	
	// @deprecated since 8.8, replaced with 'portfolio-mf'
// 	add_image_size( 'blog', 			576,  450,  true  ); 	// blog - list

	// @deprecated since 8.8, replaced with 'full'
	...
	function mfn_post_thumbnail( $postID, $type = false, $style = false, $load_more = false ){
		...
		if( is_single( $postID ) ){
			...
			if( $external == 'popup' ){
				...
				$link_title 	= '<a href="'. $large_image_url[0] .'" rel="prettyphoto[portfolio]">';
