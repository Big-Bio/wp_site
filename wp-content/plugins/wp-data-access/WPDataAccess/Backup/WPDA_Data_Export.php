...
namespace WPDataAccess\Backup {
	...
	class WPDA_Data_Export {
		...
		public function create_export( $action ) {
			...
			?>
			<div class="wrap">
				<h1 class="wp-heading-inline"><span><?php echo __( 'Data Backup' ); ?></span></h1>
				<div id="wpda_export_import">
					<div class="wpda_export_import">
						<form id="wpda_export_import_form" action="?page=wpda_backup" method="post"
		...
		public function show_wp_cron() {
			...
			echo '<div class="wrap">';
			echo '<h1 class="wp-heading-inline"><span>' . __( 'Data Backup' ) . '</span></h1>';
		...
		public function wpda_add_cron_job() {
			...
			if ( 'runonce' === $interval ) {
				...
				<div class="wrap">
					...
					<p><a href="?page=wpda_backup" class="button"><?php echo __( 'Back to main page' ); ?></a></p>
				</div>
				<?php
			} else {
