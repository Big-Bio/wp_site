			...
			<div class="wrap">
				...
				<div style="float:right;">
					<a href="javascript:void(0)" onclick="jQuery('#wpda_reset_form')[0].submit();"
					   class="button wpda_view"><?php echo __( 'Reset Form' ); ?></a>
					...
					<div id="wpda_reverse_engineering" style="display: none">
						...
						<div class="wpda_reverse_engineering">
							<form id="wpda_reverse_engineering_form"
								...
								<label for "table_name"><?php echo __( 'Load table from database' ); ?> </label>
				...
				<div class="wpda_design_table">
					...
					<form id="design_table_form" action="?page=<?php echo esc_attr( $this->page ); ?>"
						...
						<table class="wpda-table-structure">
							...
							<tr>
								<td class="wpda-table-structure-first-column">
									<label for "table_name"><?php echo __( 'Table name' ); ?> </label>
								</td>
								<td>
								...
								<td colspan="4">
									...
									if ( $this->table_exists ) {
										...
										&nbsp;<a href="javascript:void(0)"
												 ...
												 class="button"><?php echo __( 'Reconcile' ); ?></a>
										<?php
									}
									if ( $this->is_wp_table ) {
									...
									if ( ! $this->wpda_table_design ) {
										...
										<a href="javascript:void(0)"
										   ...
										   class="button wpda_view_table">
											<?php echo __( 'Load table from database (reverse engineering)' ); ?>
										</a>
										<?php
									}
									?>
							...
							<?php if ( 'advanced' === $this->design_mode ) { ?>
								...
								<tr>
									...
									<td>
										<select name="collation" id="collation" style="width: 100%;"
					...
					<form id="switch_mode_form" method="post"
						  action="?page=<?php echo esc_attr( $this->page ); ?>&table_name=<?php global $wpdb;
					      echo $wpdb->prefix . WPDA::get_option( WPDA::OPTION_WPDA_PREFIX ) . 'table_design'; ?>">
						...
						<table class="wpda-table-structure">
							...
							<tr>
								<td class="wpda-table-structure-first-column" colspan="4" style="text-align: left">
									<label><?php echo __( 'Add indexes' ); ?></label>
								</td>
							</tr>
							<tr>
