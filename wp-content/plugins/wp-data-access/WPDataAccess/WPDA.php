...
namespace WPDataAccess {
	...
	class WPDA {
		 ...
		 */
		const OPTION_WPDA_VERSION = [ 'wpda_version', '2.0.15' ];
		/**
		...
		// Back-end options.
		/**
		 * Option wpda_be_load_bootstrap and it's default value
		 */
		const OPTION_BE_LOAD_BOOTSTRAP = [ 'wpda_be_load_bootstrap', 'off' ];
		/**
